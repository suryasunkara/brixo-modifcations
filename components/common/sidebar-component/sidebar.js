...
import logo from '../../../assets/images/sigma.png';
    ...
    return (
        <Fragment>
            <div className="page-sidebar">
                <div className="main-header-left d-none d-lg-block" style={{paddingTop : "3px",backgroundColor:'#0F6999',width:"105%",marginLeft:'-10px',marginRight:'90px'}}>
